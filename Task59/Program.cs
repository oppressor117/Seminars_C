//Задайте двумерный массив из целых чисел. Напишите программу, которая удалит строчку и столбец, на пересечении которой расположен наименьший элемент массива
...
(int x, int y) SearchMinElementIn2DArray(int[,] matrix) //Композитный тип
{
    int row = 0;
    int column = 0;
...
//Выполнение конвертации массива
